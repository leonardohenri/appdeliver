create table tb_order (id int8 generated by default as identity, status int4, address varchar(255), latitude float8, longitude float8, moment timestamp, primary key (id));
